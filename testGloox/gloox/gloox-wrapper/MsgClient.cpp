...
namespace jd {
    ...
    , m_heartBeat(0) {
        ...
        void MsgClient::callbackConnect(){
            ...
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/MsgClient", "callbackConnect", "()V"))
            {
                return;
            }
        ...
        void MsgClient::callbackDisconnect(int e){
            ...
            JniMethodInfo methodInfo;
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/MsgClient", "callbackDisconnect", "(I)V"))
            {
                return;
            }
        ...
        void MsgClient::callbackRoster(const Roster& roster) {
            ...
            jclass rosterCls = getClassID(env, "com/smilegate/talk/message/RosterArray");
            ...
            JniMethodInfo methodInfo;
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/MsgClient", "callbackRoster", "(Lcom/smilegate/talk/message/RosterArray;)V"))
            {
                return;
            }
        ...
        void MsgClient::callbackVCard(const char* jid, const char* nickname, const char* photo) {
            ...
            JniMethodInfo methodInfo;
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/MsgClient", "callbackVCard", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V"))
            {
                return;
            }
        ...
        void MsgClient::callbackItemSubscribed(const char* jid) {
            ...
            JniMethodInfo methodInfo;
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/MsgClient", "callbackRosterItemSubscribed", "(Ljava/lang/String;)V"))
            {
                return;
            }
        ...
        void MsgClient::callbackItemAdded(const char* jid) {
            ...
            JniMethodInfo methodInfo;
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/MsgClient", "callbackRosterItemAdded", "(Ljava/lang/String;)V"))
            {
                return;
            }
        ...
        void MsgClient::callbackItemUnsubscribed(const char* jid) {
            ...
            JniMethodInfo methodInfo;
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/MsgClient", "callbackRosterItemUnsubscribed", "(Ljava/lang/String;)V"))
            {
                return;
            }
        ...
        void MsgClient::callbackItemRemoved(const char* jid) {
            ...
            JniMethodInfo methodInfo;
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/MsgClient", "callbackRosterItemRemoved", "(Ljava/lang/String;)V"))
            {
                return;
            }
        ...
        void MsgClient::callbackItemUpdated(const char* jid) {
            ...
            JniMethodInfo methodInfo;
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/MsgClient", "callbackRosterItemUpdated", "(Ljava/lang/String;)V"))
            {
                return;
            }
        ...
        void MsgClient::callbackSubscriptionRequest(const char* jid, const char* msg) {
            ...
            JniMethodInfo methodInfo;
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/MsgClient", "callbackSubscriptionRequest", "(Ljava/lang/String;Ljava/lang/String;)V"))
            {
                return;
            }
...
#ifdef __ANDROID_NDK__
            JniMethodInfo methodInfo;
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/MsgClient", "callbackUnsubscriptionRequest", "(Ljava/lang/String;Ljava/lang/String;)V"))
            {
                return;
            }
        ...
        void MsgClient::callbackPresence(const RosterItem& roster, const char* resource, Presence::PresenceType presence, const char* msg) {
            ...
            JniMethodInfo methodInfo;
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/MsgClient", "callbackPresence", "(Lcom/smilegate/talk/message/Roster;Ljava/lang/String;ILjava/lang/String;)V"))
            {
                return;
            }
        ...
        void MsgClient::callbackMessage(const Message& msg, MessageSession* session) {
            ...
            JniMethodInfo methodInfo;
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/MsgClient", "callbackMessage", "(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V"))
            {
                return;
            }
